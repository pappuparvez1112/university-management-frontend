...
const DepartmentsPage = () => {
  ...
  const deleteHandler = async (id: string) => {
    ...
    try {
      ...
      message.success("Academic departments Deleted successfully");
    } catch (err: any) {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: function (data: any) {
        return (
          <>
            <Link href={`/admin/academic/departments/edit/${data?.id}`}>
              <Button
                style={{
                  margin: "0px 5px",
                }}
  ...
  return (
    <div>
      ...
      />
      <ActionBar title="Academic Departments List">
        <Input
          type="text"
          size="large"
          placeholder="Search...."
        ...
        <div>
          <Link href="/admin/academic/departments/create">
